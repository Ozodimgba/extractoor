...
// First define the ProposalIxAccount type
export type ProposalIxAccount = {
    pubkey: PublicKey;
    isSigner: boolean;
    isWritable: boolean;
  };
  
  // Then define the ProposalIx type that's causing the error
  export type ProposalIx = {
    proposal: PublicKey;
    nonce: number;
    programId: PublicKey;
    accounts: ProposalIxAccount[];
    data: Buffer;
    didExecute: boolean;
    batchNum: number;
  };
